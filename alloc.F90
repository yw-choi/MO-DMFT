...
MODULE alloc
  ...
  use ionew, only: io_assign, ionode
...
call MPI_Bcast(REPORT_LEVEL,1,MPI_integer,0,comm,MPIerror)
call MPI_Bcast(REPORT_UNIT,1,MPI_integer,0,comm,MPIerror)
call MPI_Bcast(REPORT_FILE,50,MPI_character,0,comm,MPIerror)
...
if (lall) call MPI_Barrier( comm, MPIerror )
